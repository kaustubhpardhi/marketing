        ...
        <footer className="footer" id="footer">
            <div className='footer_upper'>
                <div >
                    ...
                    <p>sadkljadf lkjh sdf lkjh sd kjh asg ;kh </p>
                </div>
                <div>
                    <h3>Pages</h3>
            ...
            <div className="footer_bottum">
                ...
                <div className="social_icon">
                    <a className="social_icon_a" href="https://www.aedin.com/in/onkar-kotule-564608178/" target="_blank" rel="noreferrer">
                        <img src={insta} alt="" />
                    </a>
                    <a className="social_icon_a github" href="https://github.com/onkar95" target="_blank" rel="noreferrer">
                        <img src={fb} alt="" />
                    </a>
                    <a className="social_icon_a" href="https://www.instagram.com/onkar_95_/" target="_blank" rel="noreferrer">
                        <img src={twitter} alt="" />
                    </a>
                </div>
            </div>
